import { ArrowDownIcon, ArrowUpIcon, BookIcon, CheckIcon, XIcon } from "@phosphor-icons/react";
    ...
    <Card className="py-2 gap-0">
      ...
      <CardContent className="pt-2 px-4">
        ...
        {(() => {
          if (status === "borrowed" || status === "returned") {
            return (
              <>
                <div className="grid grid-cols-2 gap-2">
                  <p className="text-muted-foreground font-medium text-sm">Borrow Date</p>
                  <p className="text-sm">25 Jan 26</p>
                </div>
                <div className="grid grid-cols-2 gap-2 items-center">
                  <p className="text-muted-foreground font-medium text-sm">Borrow Condition</p>
        ...
        {status === "returned" && (
          <>
            <div className="grid grid-cols-2 gap-2">
              <p className="text-muted-foreground font-medium text-sm">Return Date</p>
              <p className="text-sm">10 Feb 26</p>
            </div>
            <div className="grid grid-cols-2 gap-2">
              <p className="text-muted-foreground font-medium text-sm">Return Condition</p>
              <p className="text-sm">Good</p>
            </div>
          </>
        )}
