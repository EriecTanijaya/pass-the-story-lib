        ...
        <div className="flex flex-col gap-3 p-4 overflow-y-auto mt-4">
          ...
          <Accordion>
            <AccordionItem value="synopsis">
              ...
              <AccordionContent>
                ...
                sruggling to maintain his humanity in a susiety zaled by the
                ever watchtul Big Brother. At Winston becomes increasingly
                ...
                regime 1966 aplies themes of totalitarianists, censorshup, and
                the power of language, offering a stark warning against the
                danger of abulum authority and the crusion of individual
                freedom. Wahus prophene maghen and haunting mion of a world
                where the muth it mangulated and dusent is crushed, Orwell's
                powerful narrative chillling reminder of the fragility of
                freedom and the for vigilance in the face of tyranny. Prepare to
                be challenged. fimurived, and ultimame moved by the thought
          ...
          <div>
            ...
            <ul className="list-disc list-inside">
              ...
              <li>
                Something really horrible happen, the page is burned, the ash is
                falling, the things is going out of the way
              </li>
            </ul>
          </div>
        </div>
