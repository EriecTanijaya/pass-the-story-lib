...
function RouteComponent() {
	return (
		<main className="flex flex-col max-w-7xl bg-white pt-7 px-7 pb-12 gap-5">
			<div className="relative">
				{/*<img src="/landscape.jpg" alt="book" className="h-96 object-cover" />*/}
				<div className="h-96 bg-book-card-thumbnail rounded-xl flex justify-center items-center">
