import { CopyrightIcon, InstagramLogoIcon, TiktokLogoIcon } from "@phosphor-icons/react";
    ...
    <footer className="flex flex-col px-7 border-t border-t-muted-foreground/50 py-6 gap-5 xl:px-24">
      ...
      <section className="grid grid-cols-1 gap-3 md:grid-cols-2">
        <div className="flex flex-col gap-2">
          ...
          <a href="https://www.tiktok.com/@pass.thestory" target="_blank" rel="noopener noreferrer">
            <div className="flex gap-1 text-muted-foreground items-center text-sm">
